...
import * as plus from '../assets/plus.png'
import * as post from '../assets/post-it.png'
import * as pencil from '../assets/pencil.png'
import * as remove from '../assets/delete.png'
...
const postLink = post.default
const pencilLink = pencil.default
const removeLink = remove.default
