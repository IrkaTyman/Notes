...
function NotePage({deleteNote,addNote,editNote}:editOrAddPageProps) {
    ...
    <div className="App">
        ...
        <div className="container_edit_add flex" style={{backgroundColor:`hsl(${state.note.theme||ls.getItem(state.note.id+'')||'37,100%,72%'})`}}>
            <div className="top_note_page top_panel flex">
                ...
                <div className="field_with_action flex ai_c" onClick={()=>dispatch({type:'edit',payload:state.note})}>
                ...
                <div className="field_with_action flex ai_c" onClick = {() => {deleteNote&&deleteNote(state.note.id)}}>
